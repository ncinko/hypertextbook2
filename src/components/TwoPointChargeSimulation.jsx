...
export default function DraggableTwoChargeSuperposition_Snap() {
  ...
  useEffect(() => {
    ...
    drawArrow(ctx, probe.x, probe.y, e1End.x, e1End.y, "rgba(144, 136, 135, 0.9)", 3);
    drawLabel(ctx, "E₁", e1End.x, e1End.y, E1.Ex, E1.Ey, "rgba(144, 136, 135, 0.9)", 15);

    const e2End = arrowEnd(E2);
    drawArrow(ctx, probe.x, probe.y, e2End.x, e2End.y, "rgba(144, 136, 135, 0.9)", 3);
    drawLabel(ctx, "E₂", e2End.x, e2End.y, E2.Ex, E2.Ey, "rgba(144, 136, 135, 0.9)", 15);
    ...
    ctx.strokeStyle = "#000";
    ctx.stroke();
  }, [size, q1, q2, charge1, charge2, probe]);
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <p style={{ marginTop: 8, maxWidth: 800, marginInline: "auto" }}>
        ...
        <span style={{ color: "#2e7d32" }}><b>probe point</b></span>. The {" "}
