...
export default function BeadOnRotatingRod() {
  ...
  // Controls UI
  return (
    <div ref={parentRef} className="w-full" style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12 }}>
      ...
      <canvas
        ...
        width={size.w}
        height={size.h}
        style={{ width: "100%", height: `${size.h}px`, background: "#fafafa", borderRadius: 12, boxShadow: "0 8px 20px rgba(0,0,0,0.06)", border: "1px solid #e5e7eb" }}
      />
    </div>
  );
}
