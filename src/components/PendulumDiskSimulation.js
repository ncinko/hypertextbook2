...
const CompoundPendulumSimulation = () => {
  ...
  const omega = Math.sqrt((totalMass * g * centerOfMass) / I_total);
      ...
      <div className="canvas-container">
        <svg
          ...
          style={{
            ...
            touchAction: "none",
            backgroundColor: "#2c3e50", // Darker background for smoother visuals
          }}
      ...
      <div className="control-panel w-full max-w-lg">
        <div className="slider-group">
          ...
          <div className="slider-item">
            ...
            />
            <span className="text-gray-700">{diskMass} (kg)</span>
          </div>
...
export default CompoundPendulumSimulation;