  ...
  return (
    <MathJaxContext>
      <div className="container mx-auto p-4 left-aligned-container">
        ...
        <MathJax inline>{"\\( x(t) \\approx A \\sin(\\sqrt{\\frac{g}{L}} t + \\phi) \\)"}</MathJax>
